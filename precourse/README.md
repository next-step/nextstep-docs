...
---
9. 구글 폼에 과제를 제출하기
> 주차별 미션 요구사항 문서의 구글 폼을 활용해 과제를 제출한다.
>
> 과제를 제출할 때 미션을 진행하면서 느끼고, 배운점, 많은 시간을 투자한 부분 등도 포함하면 더 좋을 것 같아요.

**Pull Request만 보내고, 구글 폼에 과제를 제출하지 않으면 미션을 제출하지 않은 것으로 처리되니 착오 없기를 바랍니다.**
